...
Registrar::~Registrar() {
    ...
    if (presentation_time_.wp_presentation) {
        LOG_TRACE("[Registrar] wp_presentation_destroy(presentation_time_.wp_presentation)");
        wp_presentation_destroy(presentation_time_.wp_presentation);
    }

#if HAS_WAYLAND_PROTOCOL_XDG_DECORATION_UNSTABLE_V1
    if (zxdg_toplevel_decoration_v1_) {
        LOG_TRACE("[Registrar] zxdg_toplevel_decoration_v1_destroy(zxdg_toplevel_decoration_v1_)");
        zxdg_toplevel_decoration_v1_destroy(zxdg_toplevel_decoration_v1_);
    }
#endif
#if HAS_WAYLAND_PROTOCOL_XDG_DECORATION_UNSTABLE_V1
    if (zxdg_decoration_manager_v1_) {
        LOG_TRACE("[Registrar] zxdg_decoration_manager_v1_destroy(zxdg_decoration_manager_v1_)");
        zxdg_decoration_manager_v1_destroy(zxdg_decoration_manager_v1_);
    }
#endif
#if HAS_WAYLAND_PROTOCOL_TEARING_CONTROL_V1
    if (wp_tearing_control_manager_) {
        LOG_TRACE("[Registrar] wp_tearing_control_manager_v1_destroy(wp_tearing_control_manager_)");
    ...
    if (fractional_scale_manager_) {
        LOG_TRACE("[Registrar] wp_fractional_scale_manager_v1_destroy(fractional_scale_manager_)");
        wp_fractional_scale_manager_v1_destroy(fractional_scale_manager_);
    }
#endif
#if HAS_WAYLAND_PROTOCOL_IDLE_INHIBIT_UNSTABLE_V1
    if (zwp_idle_inhibit_manager_v1_) {
        LOG_TRACE("[Registrar] zwp_idle_inhibit_manager_v1_destroy(zwp_idle_inhibit_manager_v1_)");
        zwp_idle_inhibit_manager_v1_destroy(zwp_idle_inhibit_manager_v1_);
    }
#endif
#if HAS_WAYLAND_PROTOCOL_POINTER_GESTURES_UNSTABLE_V1
    if (zwp_pointer_gestures_v1_) {
        LOG_TRACE("[Registrar] zwp_pointer_gestures_v1_destroy(zwp_pointer_gestures_v1_)");
        zwp_pointer_gestures_v1_destroy(zwp_pointer_gestures_v1_);
    }
#endif
#if HAS_WAYLAND_PROTOCOL_POINTER_CONSTRAINTS_UNSTABLE_V1
    if (zwp_pointer_constraints_v1_) {
        LOG_TRACE("[Registrar] zwp_pointer_constraints_v1_destroy(zwp_pointer_constraints_v1_)");
        zwp_pointer_constraints_v1_destroy(zwp_pointer_constraints_v1_);
    }
#endif
#if HAS_WAYLAND_PROTOCOL_RELATIVE_POINTER_UNSTABLE_V1
    if (zwp_relative_pointer_manager_v1_) {
        LOG_TRACE("[Registrar] zwp_relative_pointer_manager_v1_destroy(zwp_relative_pointer_manager_v1_)");
    ...
    if (zwp_primary_selection_device_manager_v1_) {
        LOG_TRACE(
                "[Registrar] zwp_primary_selection_device_manager_v1_destroy(zwp_primary_selection_device_manager_v1_)");
...
enum wl_output_transform Registrar::get_output_buffer_transform(
...
void Registrar::handle_interface_compositor(Registrar *r,
                                            ...
                                            const char *interface,
                                            uint32_t version) {
    r->wl_compositor_ = static_cast<struct wl_compositor *>(wl_registry_bind(
...
void Registrar::handle_interface_zwp_idle_inhibit_manager_v1(Registrar *r,
    ...
    LOG_DEBUG("{}: {}", interface, zwp_idle_inhibit_manager_v1_get_version(r->zwp_idle_inhibit_manager_v1_));
}
...
void Registrar::handle_interface_xdg_activation_v1(Registrar *r,
    ...
    LOG_DEBUG("{}: {}", interface, xdg_activation_v1_get_version(r->xdg_activation_v1_));
}
...
void Registrar::handle_interface_viewporter(Registrar *r,
    ...
    LOG_DEBUG("{}: {}", interface,
              wp_viewporter_get_version(r->wp_viewporter_));
}
...
void Registrar::handle_interface_zwp_pointer_gestures_v1(Registrar *r,
    ...
    LOG_DEBUG("{}: {}", interface, zwp_pointer_gestures_v1_get_version(r->zwp_pointer_gestures_v1_));
}
...
void Registrar::handle_interface_zwp_pointer_constraints_v1(Registrar *r,
    ...
    LOG_DEBUG("{}: {}", interface, zwp_pointer_constraints_v1_get_version(r->zwp_pointer_constraints_v1_));
}
