...
public:
    explicit DrmLeaseDevice_v1(struct wp_drm_lease_device_v1 *wp_drm_lease_device_v1);
...
private:
     ...
     */
    static void handle_device_drm_fd(void *data,
     ...
     */
    static void handle_device_connector(void *data,
                                        struct wp_drm_lease_device_v1 *wp_drm_lease_device_v1,
     ...
     * device.
     */
    static void handle_device_done(void *data,
                                   struct wp_drm_lease_device_v1 *wp_drm_lease_device_v1);
     ...
     */
    static void handle_device_released(void *data, struct wp_drm_lease_device_v1 *wp_drm_lease_device_v1);
     ...
     */
    static void handle_connector_name(void *data,
     ...
     */
    static void handle_connector_description(void *data,
                                             struct wp_drm_lease_connector_v1 *wp_drm_lease_connector_v1,
     ...
     */
    static void handle_connector_connector_id(void *data,
                                              struct wp_drm_lease_connector_v1 *wp_drm_lease_connector_v1,
     ...
     */
    static void handle_connector_done(void *data,
                                      struct wp_drm_lease_connector_v1 *wp_drm_lease_connector_v1);
     ...
     */
    static void handle_connector_withdrawn(void *data,
                                           struct wp_drm_lease_connector_v1 *wp_drm_lease_connector_v1);

    static constexpr struct wp_drm_lease_connector_v1_listener connector_listener_ = {
