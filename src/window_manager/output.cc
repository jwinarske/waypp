...
void Output::handle_scale(void* data, wl_output* wl_output, int32_t factor) {
...
void Output::handle_name(void* data, wl_output* wl_output, const char* name) {
...
void Output::handle_desc(void* data, wl_output* wl_output, const char* desc) {
