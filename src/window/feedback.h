...
public:
    ...
    virtual void notify_feedback_sync_output(Feedback *feedback,
                                             struct wp_presentation_feedback *wp_presentation_feedback,
                                             struct wl_output *output) = 0;

    virtual void notify_feedback_presented(Feedback *feedback,
                                           struct wp_presentation_feedback *wp_presentation_feedback,
                                           uint32_t tv_sec_hi,
                                           uint32_t tv_sec_lo,
    ...
    virtual void notify_feedback_discarded(void *data,
                                           struct wp_presentation_feedback *wp_presentation_feedback) = 0;
};

class Feedback {
public:
    Feedback(struct wp_presentation *wp_presentation, clockid_t clock_id, struct wl_surface *wl_surface, uint32_t time,
...
private:
    ...
    static void
    handle_sync_output(void *data, struct wp_presentation_feedback *wp_presentation_feedback, struct wl_output *output);

    static void handle_presented(void *data, struct wp_presentation_feedback *wp_presentation_feedback,
                                 uint32_t tv_sec_hi,
                                 uint32_t tv_sec_lo,
                                 uint32_t tv_nano_sec,
                                 uint32_t refresh,
    ...
    static void handle_discarded(void *data, struct wp_presentation_feedback *wp_presentation_feedback);
