...
class Window {
 public:
  ...
  [[nodiscard]] enum wl_output_transform get_buffer_transform() const {
  ...
  void set_needs_buffer_geometry_update(bool value) {
  ...
  void set_runtime_mode(RuntimeMode runtime_mode) {
 ...
 private:
  ...
  enum wl_output_transform preferred_buffer_transform_ =
